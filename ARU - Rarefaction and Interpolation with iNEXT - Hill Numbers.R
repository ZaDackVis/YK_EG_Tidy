...
#Unifying Species Diversity,Phylogenetic Diversity,Functional Diversity, and
#Related Similarity and Differentiation MeasuresThrough Hill Numbers
...
Alpine <- Alpine[-c(56:61)]               #I don't require the location data.
SubAlp <- SubAlp[-c(56:61)]
Boreal <- Boreal[-c(56:61)]
